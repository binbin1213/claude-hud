...
export async function main(overrides = {}) {
    ...
    try {
        ...
        const isGLM = isGLMModelId(stdin.model?.id) || isGLMModelId(stdin.model?.display_name);
        const usageData = !isGLM && config.display.showUsage !== false
            ? await deps.getUsage({
                ttls: {
            ...
            : null;
        // 智谱额度查询
        const zhipuUsage = isGLM ? await getZhipuUsage() : null;
